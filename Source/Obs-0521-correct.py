...
raw = PRE_DIR + 'RollingShutterSim/Observations/0521/CA0001_20180521_012018_461559/raw/'

ftp_name = 'FTPdetectinfo_CA0001_20180521_012018_461559.txt'

rms_dir = PRE_DIR + 'RMS/'
project_dir = PRE_DIR + 'RollingShutterSim/'
ftps_dir = PRE_DIR + 'RollingShutterSim/Observations/0521/CA0001_20180521_012018_461559/ftps'
...
os.system('cp ' + raw + ftp_name[:-4] + '_spatial.txt ' + raw + ftp_name[:-4] + '_temporal.txt ' + ftps_dir)