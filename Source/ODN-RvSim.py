...
for noise in par.noise_scale_arr:
	...
	for omega_iter in par.omega_odn_arr:
		...
		for i in range(n_iter):
			...
			# Apply coordinate correction (1st version, without velocity correction)
			centroid_coordinates = st.coordinateCorrection(time_coordinates, centroid_coordinates, par.img_y, par.fps, version='v')
...
np.savez('../Data/ODN/data_odn_v_rolling.npz', *[par.omega_odn_arr, noise0_arr, noise1_arr, noise2_arr, noise3_arr])